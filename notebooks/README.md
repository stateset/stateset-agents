...
| [`whitepaper_v1_gsm8k_benchmark.ipynb`](./whitepaper_v1_gsm8k_benchmark.ipynb) | RL train, verifiable | ~45 min | ~$0.50 | Schema-compliant benchmark JSON for §11.7 of the whitepaper. GSM8K math reasoning under GSPO. |
...
Three legacy notebooks (`00_environment_setup.ipynb`, `01_qwen_support_agent_gspo.ipynb`, `02_qwen_sales_agent_gspo.ipynb`) remain for backward compatibility but are superseded by the six above.
...
| "Reproduce a whitepaper benchmark" | `whitepaper_v1_gsm8k_benchmark` |
...
All six core notebooks are JSON-validated in CI on every PR that touches them. See [`.github/workflows/benchmark-smoke.yml`](../.github/workflows/benchmark-smoke.yml).
