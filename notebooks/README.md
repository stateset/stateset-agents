...
Three legacy notebooks (`00_environment_setup.ipynb`, `01_qwen_support_agent_gspo.ipynb`, `02_qwen_sales_agent_gspo.ipynb`) remain for backward compatibility but are superseded by the seven above.
...
All seven core notebooks are JSON-validated in CI on every PR that touches them. See [`.github/workflows/benchmark-smoke.yml`](../.github/workflows/benchmark-smoke.yml).
