"""Thin forwarder for the Nemotron 3.5 GSPO finetune script.
...
print(
    "examples/finetune_nemotron_3_5_gspo.py is a forwarder; use "
    "'python examples/finetune_gspo.py --model nemotron-3-5' instead.",
    file=sys.stderr,
)
sys.exit(_driver_main(["--model", "nemotron-3-5", *sys.argv[1:]]))
