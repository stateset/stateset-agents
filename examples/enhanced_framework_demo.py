...
async def demonstrate_performance_optimization():
    ...
    optimizer = PerformanceOptimizer(optimization_level=OptimizationLevel.BALANCED)
...
async def demonstrate_async_resource_management():
    ...
    async with managed_async_resources():
        ...
        tasks = [sample_task(i, 0.1 + i * 0.05) for i in range(10)]
...
async def demonstrate_integrated_agent():
    ...
    try:
        ...
        ).memory_monitor.memory_context("conversation"):
            conversation_turns = [
...
async def run_comprehensive_demo():
    ...
    for demo_name, demo_func in demo_functions:
        ...
        try:
            ...
            results[demo_name] = {"success": success, "duration": duration}
