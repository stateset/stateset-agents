...
class TestNeuralRewardTrainer:
    ...
    @pytest.mark.skipif(not hasattr(NeuralRewardTrainer, '__init__'), reason="Neural reward trainer not available")
...
class TestIntegration:
    ...
    @pytest.mark.asyncio
    async def test_end_to_end_training_workflow(self, test_agent, test_environment, test_reward_function):
...
class TestPerformance:
    ...
    @pytest.mark.asyncio
    async def test_parallel_trajectory_generation_performance(self, test_agent, test_environment, test_reward_function):
