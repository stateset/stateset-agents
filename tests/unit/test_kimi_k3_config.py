...
class TestKimiK3StarterScript:
    ...
    def test_training_function_signature(self):
        from examples import finetune_kimi_k3_gspo as training_module

        sig = inspect.signature(training_module.finetune_kimi_k3)
    ...
    def test_dry_run_preview(self):
        ...
        preview = asyncio.run(training_module.finetune_kimi_k3(dry_run=True))

        assert preview["config"]["model_name"] == KIMI_K3_BASE_MODEL
