...
from stateset_agents.core.agent import Agent, MultiTurnAgent, AgentConfig
...
class TestAgent:
    ...
    @patch('stateset_agents.core.agent.AutoModelForCausalLM')
    @patch('stateset_agents.core.agent.AutoTokenizer')
    async def test_agent_async_initialization(self, mock_tokenizer, mock_model, agent_config):
...
class TestMultiTurnAgent:
    ...
    @patch('stateset_agents.core.agent.AutoModelForCausalLM')
    @patch('stateset_agents.core.agent.AutoTokenizer')
    async def test_multiturn_agent_initialization(self, mock_tokenizer, mock_model, multiturn_agent_config):
    ...
    @patch('stateset_agents.core.agent.AutoModelForCausalLM')
    @patch('stateset_agents.core.agent.AutoTokenizer')
    async def test_multiturn_agent_generate_response(self, mock_tokenizer, mock_model, multiturn_agent_config):
