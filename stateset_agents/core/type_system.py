...
class TrainingConfig(TypedDict, total=False):
    ...
    adam_beta1: NotRequired[float]
    adam_beta2: NotRequired[float]
    adam_epsilon: NotRequired[float]
    weight_decay: NotRequired[float]
    max_grad_norm: NotRequired[float]
    ...
    eval_num_generations: NotRequired[int]
    ...
    reward_clip: NotRequired[float]
    advantage_normalization: NotRequired[bool]
    baseline_type: NotRequired[str]
    beta: NotRequired[float]
    use_reference_model: NotRequired[bool]
    clip_ratio: NotRequired[float]
    value_clip: NotRequired[float]
    entropy_coef: NotRequired[float]
    continual_strategy: NotRequired[str]
    replay_buffer_size: NotRequired[int]
    replay_ratio: NotRequired[float]
    replay_min_size: NotRequired[int]
    replay_sampling: NotRequired[str]
    replay_storage: NotRequired[str]
    continual_kl_beta: NotRequired[float]
    ewc_lambda: NotRequired[float]
    ...
    run_post_eval: NotRequired[bool]
    post_eval_samples: NotRequired[int]
    post_eval_detailed: NotRequired[bool]
