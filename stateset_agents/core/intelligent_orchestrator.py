"""Deprecated shim: moved to `stateset_agents.experimental.intelligent_orchestrator`.
...
from stateset_agents.experimental import intelligent_orchestrator as _new

warnings.warn(
    "stateset_agents.core.intelligent_orchestrator has moved to "
    "stateset_agents.experimental.intelligent_orchestrator; the old import path is "
