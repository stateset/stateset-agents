...
_OPTIONAL_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "KIMI_K26_CONFIG_SUFFIXES": (f"{__name__}.kimi_k2_6_starter", "KIMI_K26_CONFIG_SUFFIXES"),
    "KIMI_K26_DEFAULT_OUTPUT_DIR": (f"{__name__}.kimi_k2_6_starter", "KIMI_K26_DEFAULT_OUTPUT_DIR"),
    "KIMI_K26_LORA_TARGET_MODULES": (f"{__name__}.kimi_k2_6_starter", "KIMI_K26_LORA_TARGET_MODULES"),
    "KIMI_K26_STARTER_PROFILE_CHOICES": (f"{__name__}.kimi_k2_6_starter", "KIMI_K26_STARTER_PROFILE_CHOICES"),
    "KIMI_K26_STARTER_PROFILE_DESCRIPTIONS": (f"{__name__}.kimi_k2_6_starter", "KIMI_K26_STARTER_PROFILE_DESCRIPTIONS"),
    "KIMI_K26_SUPPORTED_VARIANTS": (f"{__name__}.kimi_k2_6_starter", "KIMI_K26_SUPPORTED_VARIANTS"),
    ...
    "create_kimi_k2_6_agent_config": (f"{__name__}.kimi_k2_6_starter", "create_kimi_k2_6_agent_config"),
    "create_kimi_k2_6_preview": (f"{__name__}.kimi_k2_6_starter", "create_kimi_k2_6_preview"),
    "describe_kimi_k2_6_starter_profiles": (f"{__name__}.kimi_k2_6_starter", "describe_kimi_k2_6_starter_profiles"),
    ...
    "get_kimi_k2_6_gspo_config": (f"{__name__}.kimi_k2_6_starter", "get_kimi_k2_6_gspo_config"),
    "get_kimi_k2_6_gspo_overrides": (f"{__name__}.kimi_k2_6_starter", "get_kimi_k2_6_gspo_overrides"),
    "get_kimi_k2_6_profile_description": (f"{__name__}.kimi_k2_6_starter", "get_kimi_k2_6_profile_description"),
    "get_kimi_k2_6_profile_overrides": (f"{__name__}.kimi_k2_6_starter", "get_kimi_k2_6_profile_overrides"),
    "get_kimi_k2_6_system_prompt": (f"{__name__}.kimi_k2_6_starter", "get_kimi_k2_6_system_prompt"),
    "load_kimi_k2_6_config_file": (f"{__name__}.kimi_k2_6_starter", "load_kimi_k2_6_config_file"),
    "run_kimi_k2_6_config": (f"{__name__}.kimi_k2_6_starter", "run_kimi_k2_6_config"),
    "summarize_kimi_k2_6_config": (f"{__name__}.kimi_k2_6_starter", "summarize_kimi_k2_6_config"),
    "validate_kimi_k2_6_config": (f"{__name__}.kimi_k2_6_starter", "validate_kimi_k2_6_config"),
    "write_kimi_k2_6_config_file": (f"{__name__}.kimi_k2_6_starter", "write_kimi_k2_6_config_file"),
    # Kimi-K3 starter path
    "KIMI_K3_BASE_MODEL": (f"{__name__}.kimi_k3_starter", "KIMI_K3_BASE_MODEL"),
    "KIMI_K3_CONFIG_SUFFIXES": (f"{__name__}.kimi_k3_starter", "KIMI_K3_CONFIG_SUFFIXES"),
    "KIMI_K3_DEFAULT_OUTPUT_DIR": (f"{__name__}.kimi_k3_starter", "KIMI_K3_DEFAULT_OUTPUT_DIR"),
    "KIMI_K3_LORA_TARGET_MODULES": (f"{__name__}.kimi_k3_starter", "KIMI_K3_LORA_TARGET_MODULES"),
    "KIMI_K3_STARTER_PROFILE_CHOICES": (f"{__name__}.kimi_k3_starter", "KIMI_K3_STARTER_PROFILE_CHOICES"),
    "KIMI_K3_STARTER_PROFILE_DESCRIPTIONS": (f"{__name__}.kimi_k3_starter", "KIMI_K3_STARTER_PROFILE_DESCRIPTIONS"),
    "KIMI_K3_SUPPORTED_VARIANTS": (f"{__name__}.kimi_k3_starter", "KIMI_K3_SUPPORTED_VARIANTS"),
    "KIMI_K3_TASK_CHOICES": (f"{__name__}.kimi_k3_starter", "KIMI_K3_TASK_CHOICES"),
    "KimiK3Config": (f"{__name__}.kimi_k3_starter", "KimiK3Config"),
    "create_kimi_k3_agent_config": (f"{__name__}.kimi_k3_starter", "create_kimi_k3_agent_config"),
    "create_kimi_k3_preview": (f"{__name__}.kimi_k3_starter", "create_kimi_k3_preview"),
    "describe_kimi_k3_starter_profiles": (f"{__name__}.kimi_k3_starter", "describe_kimi_k3_starter_profiles"),
    ...
    "get_kimi_k3_gspo_config": (f"{__name__}.kimi_k3_starter", "get_kimi_k3_gspo_config"),
    "get_kimi_k3_gspo_overrides": (f"{__name__}.kimi_k3_starter", "get_kimi_k3_gspo_overrides"),
    "get_kimi_k3_profile_description": (f"{__name__}.kimi_k3_starter", "get_kimi_k3_profile_description"),
    "get_kimi_k3_profile_overrides": (f"{__name__}.kimi_k3_starter", "get_kimi_k3_profile_overrides"),
    "get_kimi_k3_system_prompt": (f"{__name__}.kimi_k3_starter", "get_kimi_k3_system_prompt"),
    "load_kimi_k3_config_file": (f"{__name__}.kimi_k3_starter", "load_kimi_k3_config_file"),
    "run_kimi_k3_config": (f"{__name__}.kimi_k3_starter", "run_kimi_k3_config"),
    "summarize_kimi_k3_config": (f"{__name__}.kimi_k3_starter", "summarize_kimi_k3_config"),
    "validate_kimi_k3_config": (f"{__name__}.kimi_k3_starter", "validate_kimi_k3_config"),
    "write_kimi_k3_config_file": (f"{__name__}.kimi_k3_starter", "write_kimi_k3_config_file"),
    # Serving artifacts
    ...
    "GLM5_2_DEFAULT_OUTPUT_DIR": (f"{__name__}.glm5_2_starter", "GLM5_2_DEFAULT_OUTPUT_DIR"),
    "GLM5_2_FP8_MODEL": (f"{__name__}.glm5_2_starter", "GLM5_2_FP8_MODEL"),
    "GLM5_2_LORA_TARGET_MODULES": (f"{__name__}.glm5_2_starter", "GLM5_2_LORA_TARGET_MODULES"),
    "GLM5_2_STARTER_PROFILE_CHOICES": (f"{__name__}.glm5_2_starter", "GLM5_2_STARTER_PROFILE_CHOICES"),
    "GLM5_2_STARTER_PROFILE_DESCRIPTIONS": (f"{__name__}.glm5_2_starter", "GLM5_2_STARTER_PROFILE_DESCRIPTIONS"),
    "GLM5_2_SUPPORTED_VARIANTS": (f"{__name__}.glm5_2_starter", "GLM5_2_SUPPORTED_VARIANTS"),
    "GLM5_2_TASK_CHOICES": (f"{__name__}.glm5_2_starter", "GLM5_2_TASK_CHOICES"),
    "Glm52Config": (f"{__name__}.glm5_2_starter", "Glm52Config"),
    "create_glm5_2_agent_config": (f"{__name__}.glm5_2_starter", "create_glm5_2_agent_config"),
    "create_glm5_2_preview": (f"{__name__}.glm5_2_starter", "create_glm5_2_preview"),
    "describe_glm5_2_starter_profiles": (f"{__name__}.glm5_2_starter", "describe_glm5_2_starter_profiles"),
    ...
    "get_glm5_2_gspo_overrides": (f"{__name__}.glm5_2_starter", "get_glm5_2_gspo_overrides"),
    "get_glm5_2_profile_description": (f"{__name__}.glm5_2_starter", "get_glm5_2_profile_description"),
    "get_glm5_2_profile_overrides": (f"{__name__}.glm5_2_starter", "get_glm5_2_profile_overrides"),
    "get_glm5_2_serving_recommendations": (f"{__name__}.glm5_2_starter", "get_glm5_2_serving_recommendations"),
    "get_glm5_2_system_prompt": (f"{__name__}.glm5_2_starter", "get_glm5_2_system_prompt"),
    "load_glm5_2_config_file": (f"{__name__}.glm5_2_starter", "load_glm5_2_config_file"),
    "run_glm5_2_config": (f"{__name__}.glm5_2_starter", "run_glm5_2_config"),
    "summarize_glm5_2_config": (f"{__name__}.glm5_2_starter", "summarize_glm5_2_config"),
    "validate_glm5_2_config": (f"{__name__}.glm5_2_starter", "validate_glm5_2_config"),
    "write_glm5_2_config_file": (f"{__name__}.glm5_2_starter", "write_glm5_2_config_file"),
