...
def get_kimi_k2_6_profile_overrides(
    ...
    return _common.select_profile_overrides(
        ...
        choices=KIMI_K26_STARTER_PROFILE_CHOICES,
...
def get_kimi_k2_6_profile_description(starter_profile: str = "balanced") -> str:
    ...
    return _common.select_profile_description(
        starter_profile,
        descriptions=KIMI_K26_STARTER_PROFILE_DESCRIPTIONS,
        choices=KIMI_K26_STARTER_PROFILE_CHOICES,
        family_label=_FAMILY_LABEL,
    )
...
def describe_kimi_k2_6_starter_profiles(
    ...
    return _common.describe_starter_profiles(
        ...
        choices=KIMI_K26_STARTER_PROFILE_CHOICES,
        get_config=get_kimi_k2_6_config,
        get_description=get_kimi_k2_6_profile_description,
        summarize=summarize_kimi_k2_6_config,
    )


@dataclass
class KimiK26Config(_common.StarterConfigMixin):
    ...
    _system_prompt = staticmethod(get_kimi_k2_6_system_prompt)
    _wandb_base_tags = ("kimi-k2.6", "gspo")
    _wandb_project_default = "kimi_k2_6-gspo"
...
def get_kimi_k2_6_gspo_config(
    ...
    return _common.build_gspo_config(
        config, base_config, get_config_for_task, get_kimi_k2_6_gspo_overrides
    )
...
def create_kimi_k2_6_preview(
    ...
    return _common.create_preview(
        config,
        warnings,
        agent_config_fn=create_kimi_k2_6_agent_config,
        summarize_fn=summarize_kimi_k2_6_config,
        gspo_overrides_fn=get_kimi_k2_6_gspo_overrides,
    )
...
def load_kimi_k2_6_config_file(path: str | Path) -> KimiK26Config:
    ...
    return _common.load_config_file(
        path,
        config_cls=KimiK26Config,
        suffixes=KIMI_K26_CONFIG_SUFFIXES,
        family_label=_FAMILY_LABEL,
...
def write_kimi_k2_6_config_file(
    ...
    return _common.write_config_file(
        ...
        path,
        include_preview,
        preview_fn=create_kimi_k2_6_preview,
        suffixes=KIMI_K26_CONFIG_SUFFIXES,
        family_label=_FAMILY_LABEL,
        display_name=_DISPLAY_NAME,
        logger=logger,
...
async def run_kimi_k2_6_config(
    ...
    return await _common.run_starter_config(
        ...
        dry_run,
        preview_fn=create_kimi_k2_6_preview,
        gspo_config_fn=get_kimi_k2_6_gspo_config,
        agent_config_fn=create_kimi_k2_6_agent_config,
        display_name=_DISPLAY_NAME,
        logger=logger,
    )
...
async def finetune_kimi_k2_6(
    ...
    return await _common.finetune_starter(
        get_config_fn=get_kimi_k2_6_config,
        run_fn=run_kimi_k2_6_config,
        model_name=model_name,
        task=task,
        starter_profile=starter_profile,
        use_lora=use_lora,
