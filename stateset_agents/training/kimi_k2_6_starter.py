...
KIMI_K26_STARTER_PROFILE_CHOICES = ["balanced", "memory", "quality"]


def validate_kimi_k2_6_config(config: Any) -> list[str]:
...
SPEC = StarterSpec(
    ...
    symbol_prefix="KIMI_K26",
    fn_infix="kimi_k2_6",
    run_suffix="kimi_k2_6",
    config_class_name="KimiK26Config",
    base_model=KIMI_K26_BASE_MODEL,
    post_trained_model=None,
    supported_variants=["moonshotai/Kimi-K2.6"],
    task_choices=KIMI_K26_TASK_CHOICES,
    profile_choices=KIMI_K26_STARTER_PROFILE_CHOICES,
    default_output_dir="./outputs/kimi_k2_6_gspo",
    lora_target_modules=[
        "q_proj",
        "k_proj",
        "v_proj",
    ...
    extra_fields=(),
    wandb_base_tags=("kimi-k2.6", "gspo"),
    wandb_project_default="kimi_k2_6-gspo",
    validate=validate_kimi_k2_6_config,
    module=__name__,
)
