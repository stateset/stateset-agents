...
GLM5_1_STARTER_PROFILE_CHOICES = ["balanced", "memory", "quality"]
GLM5_1_FP8_MODEL = "your-org/GLM-5.1-FP8"


def validate_glm5_1_config(config: Any) -> list[str]:
...
SPEC = StarterSpec(
    ...
    symbol_prefix="GLM5_1",
    fn_infix="glm5_1",
    run_suffix="glm5_1",
    config_class_name="Glm51Config",
    base_model=GLM5_1_BASE_MODEL,
    post_trained_model=None,
    supported_variants=["zai-org/GLM-5.1", "your-org/GLM-5.1-FP8"],
    task_choices=GLM5_1_TASK_CHOICES,
    profile_choices=GLM5_1_STARTER_PROFILE_CHOICES,
    default_output_dir="./outputs/glm5_1_gspo",
    lora_target_modules=[
        "q_a_proj",
        "q_b_proj",
        "kv_a_proj_with_mqa",
    ...
    system_prompt_intro="You are GLM, a helpful AI assistant built from the GLM 5.1 reasoning checkpoint by Zhipu AI.",
    config_defaults={
        "lora_r": 64,
        "lora_alpha": 128,
        "use_4bit": True,
    ...
    wandb_base_tags=("glm5.1", "754b", "moe", "gspo"),
    wandb_project_default="glm5_1-gspo",
    validate=validate_glm5_1_config,
    module=__name__,
)
