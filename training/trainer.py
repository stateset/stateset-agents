...
def _require_transformers() -> None:
    ...
    global DataCollatorForLanguageModeling, TrainingArguments, get_cosine_schedule_with_warmup, get_linear_schedule_with_warmup
    if (
        ...
        for episode in range(num_episodes):
            ...
            for step in range(max_steps):
                ...
                if self.reward_fn is not None:
                    ...
                    reward = reward_result.score if hasattr(reward_result, "score") else reward_result
                else:
